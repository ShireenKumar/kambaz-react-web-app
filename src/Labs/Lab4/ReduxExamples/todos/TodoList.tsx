...
export default function TodoList() {
  ...
  // ✅ Renaming the Redux state variable to `reduxTodos`
  const { todos: reduxTodos } = useSelector((state: any) => state.todosReducer);
  ...
  return (
    <div>
      ...
      <ListGroup>
        <TodoForm />
        {reduxTodos.map((todo: any) => (
          <TodoItem key={todo.id} todo={todo} />
        ))}
      </ListGroup>

      {/* Local State-based Todos */}
      <ListGroup>
        <ListGroup.Item>
